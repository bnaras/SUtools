...
8. Next `gfortran` is run on the code with flags `Wunusued` to detect
   unused labels. The output is then scanned for the warning messages.
...
10. If registration is asked for and a package name is provided, the
    ...
    on the package, `pcLasso_init.c` in our example. 
